...
@ZenClass("mods.emergingtechnology.Hydroponic")
public class Hydroponic {
    ...
    private static class Add implements IAction {
        ...
        public String describe() {
            return "Adding Hydroponic Recipe for " + recipe.getOutput().getDisplayName();
        }
    }
    ...
    private static class Remove implements IAction {
        ...
        @Override
        public void apply() {
            HydroponicRecipes.removeByOutput(output);
        }

        @Override
        public String describe() {
            return "Removing Hydroponic Recipe for " + output.getDisplayName();
        }
    }
    ...
    private static class RemoveAll implements IAction {
        @Override
        public void apply() {
            HydroponicRecipes.removeAll();
        }

        @Override
        public String describe() {
            return "Removing all Hydroponic Recipes";
        }
    }
}
